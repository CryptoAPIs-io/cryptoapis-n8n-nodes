		...
		options: [
			{
				...
				action: 'Get asset details by ID',
			},
			{
				...
				action: 'Get asset details by symbol',
			},
			{
				...
				action: 'Get exchange rate by asset symbols',
			},
			{
