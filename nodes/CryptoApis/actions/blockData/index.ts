...
export const blockDataOperations: INodeProperties[] = [
	...
	},
	{
		...
		displayOptions: { show: { resource: ['blockData'] } },
		options: [
			{ name: 'Get Block by Height', value: 'getBlockByHeight', description: 'Get block details by block height', action: 'Get block by height' },
			{ name: 'Get Block by Hash', value: 'getBlockByHash', description: 'Get block details by block hash', action: 'Get block by hash' },
			{ name: 'List Transactions by Block Hash', value: 'listTransactionsByBlockHash', description: 'List transactions within a specific block by hash', action: 'List transactions by block hash' },
			{ name: 'List Transactions by Block Height', value: 'listTransactionsByBlockHeight', description: 'List transactions within a specific block by height', action: 'List transactions by block height' },
			{ name: 'Get Last Mined Block', value: 'getLastMinedBlock', description: 'Get the latest mined block', action: 'Get last mined block' },
			{ name: 'List Latest Mined Blocks', value: 'listLatestMinedBlocks', description: 'List the most recently mined blocks', action: 'List latest mined blocks' },
		],
