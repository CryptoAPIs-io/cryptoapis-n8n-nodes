...
export const addressHistoryOperations: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{ name: 'List Unspent Outputs', value: 'listUnspentOutputs', description: 'List unspent transaction outputs — UTXOs (UTXO only)', action: 'List unspent transaction outputs' },
