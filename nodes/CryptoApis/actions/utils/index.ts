...
export const utilsOperations: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{ name: 'Derive Addresses', value: 'deriveAddresses', description: 'Derive addresses from an extended public key (EVM/UTXO/XRP)', action: 'Derive addresses from an xPub key' },
			{ name: 'Convert Bitcoin Cash Address', value: 'convertBitcoinCashAddress', description: 'Convert between legacy and CashAddr formats (UTXO — Bitcoin Cash only)', action: 'Convert between BCH legacy and CashAddr' },
			{ name: 'Decode X-Address', value: 'decodeXAddress', description: 'Decode an X-Address to classic address + tag (XRP only)', action: 'Decode an XRP X-Address to classic + tag' },
			{ name: 'Encode X-Address', value: 'encodeXAddress', description: 'Encode a classic address + tag into an X-Address (XRP only)', action: 'Encode an XRP classic address into X-Address' },
		],
